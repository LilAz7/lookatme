                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <div class="card">
                            ...
                            <div class="card__bottom">
                                ...
                                <div class="card__title">Брэнд: ' . htmlspecialchars($row['author'], ENT_QUOTES, 'UTF-8') . '</div>
                                <div class="card__title">Кол-во: ' . htmlspecialchars($row['pages'], ENT_QUOTES, 'UTF-8') . '</div>
                                <div class="card__title">Год выхода: ' . htmlspecialchars($row['year'], ENT_QUOTES, 'UTF-8') . '</div>
                            </div>
                        </div>';
                    }
                } else {
