                        ...
                        <div class="container">
                            <div class="cart-item">
                                ...
                                <div class="cart-item-details">
                                    ...
                                    <div class="cart-item-author">Брэнд: ' . htmlspecialchars($row['author'], ENT_QUOTES, 'UTF-8') . '</div>
                                    <div class="cart-item-pages">Кол-во: ' . htmlspecialchars($row['pages'], ENT_QUOTES, 'UTF-8') . '</div>
                                    <div class="cart-item-year">Год выхода: ' . htmlspecialchars($row['year'], ENT_QUOTES, 'UTF-8') . '</div>
