        ...
        if (isset($_GET['category_id'])) {
            ...
            try {
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    echo "В этом типе нет товаров";
                }
            } catch (PDOException $e) {
                echo "Ошибка при выполнении запроса: " . $e->getMessage();
            }
        } else {
            echo '<h1>Выберите тип из каталога</h1>';
        }
        ?>
    </div>
</div>
